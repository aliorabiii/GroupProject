...
<div class="section testimonials bg-dark   py-5">
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
        <div class="owl-carousel owl-testimonials">
          ...
          <div class="item text-white">
            <p class="lead">"IWAITER has transformed our restaurant workflow. The digital interface is intuitive, fast, and reduces errors significantly."</p>
            <div class="author d-flex align-items-center mt-3">
              <img src="assets/images/testimonial-author.jpg" class="rounded-circle me-3" alt="">
              <div>
                <span class="text-warning fw-bold">Restaurant Manager</span>
                <h4 class="text-white mb-0">Claude David</h4>
              </div>
            </div>
          </div>
          <!-- Testimonial 2 -->
          <div class="item text-white">
            <p class="lead">"Switching to IWAITER has been seamless. Customers love the smooth ordering experience, and our staff productivity has increased."</p>
            <div class="author d-flex align-items-center mt-3">
              <img src="assets/images/testimonial-author.jpg" class="rounded-circle me-3" alt="">
              <div>
                <span class="text-warning fw-bold">UI/UX Expert</span>
                <h4 class="text-white mb-0">Thomas Jefferson</h4>
              </div>
            </div>
          </div>
          <!-- Testimonial 3 -->
          <div class="item text-white">
            <p class="lead">"IWAITER's interface is sleek and modern. It perfectly balances functionality with user experience for both customers and staff."</p>
            <div class="author d-flex align-items-center mt-3">
              <img src="assets/images/testimonial-author.jpg" class="rounded-circle me-3" alt="">
              <div>
                <span class="text-warning fw-bold">Digital Consultant</span>
                <h4 class="text-white mb-0">Stella Blair</h4>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-5 d-flex align-items-center">
        <div class="section-heading text-warning">
          ...
          <p class="text-white">See how IWAITER is helping restaurants optimize service, improve customer experience, and boost efficiency.</p>
        </div>
      </div>
    </div>
  </div>
