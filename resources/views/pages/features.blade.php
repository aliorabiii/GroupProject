...
<section class="features-section py-5 bg-light">
  <div class="container">
    ...
    <div class="row g-4">
      <!-- Feature Item 1 -->
      <div class="col-md-4">
        <div class="feature-card text-center p-4 bg-white shadow-sm rounded hover-effect">
          <i class="bi bi-receipt-cutoff display-4 text-primary mb-3"></i>
          <h5 class="fw-bold">Order Management</h5>
          <p class="text-muted">Track orders from kitchen to table seamlessly with real-time updates.</p>
          <img src="images/order-management.png" alt="Order Management" class="feature-img mt-3">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="feature-card text-center p-4 bg-white shadow-sm rounded hover-effect">
          ...
          <p class="text-muted">Receive automated stock alerts to reduce waste and optimize resources.</p>
          <img src="" alt="Inventory Tracking" class="feature-img mt-3">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="feature-card text-center p-4 bg-white shadow-sm rounded hover-effect">
          ...
          <h5 class="fw-bold">Staff Scheduling</h5>
          <p class="text-muted">Optimize shifts, track attendance, and manage payroll effortlessly.</p>
          <img src="images/staff-scheduling.png" alt="Staff Scheduling" class="feature-img mt-3">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="feature-card text-center p-4 bg-white shadow-sm rounded hover-effect">
          ...
          <h5 class="fw-bold">Menu Management</h5>
          <p class="text-muted">Update menus instantly and manage pricing with ease.</p>
          <img src="images/menu-management.png" alt="Menu Management" class="feature-img mt-3">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="feature-card text-center p-4 bg-white shadow-sm rounded hover-effect">
          ...
          <p class="text-muted">Collect ratings, reviews, and feedback to enhance customer satisfaction.</p>
          <img src="images/customer-feedback.png" alt="Customer Feedback" class="feature-img mt-3">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="feature-card text-center p-4 bg-white shadow-sm rounded hover-effect">
          ...
          <p class="text-muted">Visualize sales, trends, and performance metrics in a user-friendly dashboard.</p>
          <img src="images/analytics-dashboard.png" alt="Analytics Dashboard" class="feature-img mt-3">
        </div>
      </div>
    </div>
  </div>
