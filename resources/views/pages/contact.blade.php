    ...
    <div class="row">
      ...
      <div class="col-lg-6 align-self-center">
        <div class="section-heading">
          ...
          <p>
            Thank you for choosing our templates. We provide you the best CSS templates at 100% free of charge. Support us by sharing our website.
          </p>
        ...
        <div class="contact-us-content">
          <form id="contact-form" action="" method="post">
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                  <button type="submit" id="form-submit" class="yellow-button">Send Message Now</button>
                </fieldset>
              </div>
            </div>
          </form>
